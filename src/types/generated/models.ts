...
export type AggregateDataExchangeJobParameters = {
    dataExchangeIds: Array<UID>
}

export type AnalyticsJobParameters = {
    lastYears: number
    skipPrograms: Array<UID>
...
export type AttributeInfo = {
    /**
     * A UID for an AttributeInfo object
    ...
    value: string
    valueType: AttributeInfo.valueType
}

export namespace AttributeInfo {
    export enum valueType {
        TEXT = 'TEXT',
        LONG_TEXT = 'LONG_TEXT',
        MULTI_TEXT = 'MULTI_TEXT',
...
export type Body = {
    ...
    trackedEntities: Array<TrackedEntityInfo>
}
...
export type EnrollmentInfo = {
    ...
    /**
     * A UID for an EnrollmentInfo object
    ...
    storedBy: string
    /**
     * A UID for an TrackedEntityInfo object
...
export namespace EnrollmentInfo {
    export enum status {
        ACTIVE = 'ACTIVE',
        COMPLETED = 'COMPLETED',
        CANCELLED = 'CANCELLED',
...
export type EventFilterInfo = {
    assignedUserMode: EventFilterInfo.assignedUserMode
    assignedUsers: Array<string>
    eventCreatedPeriod: FilterPeriod
    eventStatus: EventFilterInfo.eventStatus
    programStage: string
}

export namespace EventFilterInfo {
    export enum assignedUserMode {
        CURRENT = 'CURRENT',
        PROVIDED = 'PROVIDED',
        NONE = 'NONE',
...
export type EventInfo = {
    ...
    createdAtClient: string | number
    createdBy: TrackerUser
    dataValues: Array<DataValueInfo>
    deleted: boolean
    /**
     * A UID for an EnrollmentInfo object
     * (Java name `org.hisp.dhis.webapi.controller.tracker.view.Enrollment`)
...
export type ExchangeTarget = {
    ...
    type: ExchangeTarget.type
}

export namespace ExchangeTarget {
    export enum type {
        INTERNAL = 'INTERNAL',
        EXTERNAL = 'EXTERNAL',
    }
...
export type MonitoringJobParameters = {
    ...
    validationRuleGroups: Array<UID>
}
...
export type PredictorJobParameters = {
    predictorGroups: Array<UID>
    predictors: Array<UID>
    relativeEnd: number
    relativeStart: number
}
...
export type RelationshipInfo = {
    ...
    /**
     * A UID for an RelationshipInfo object
...
export type RelationshipItemInfo = {
    enrollment?: {
        ...
        orgUnitName: string
        program: string
        status: RelationshipItemInfo.status
        storedBy: string
        trackedEntity: string
        updatedAt: string | number
        updatedAtClient: string | number
    ...
    trackedEntity?: {
        ...
        programOwners: Array<ProgramOwnerInfo>
        storedBy: string
        /**
...
export namespace RelationshipItemInfo {
    export enum status {
        ACTIVE = 'ACTIVE',
        COMPLETED = 'COMPLETED',
        CANCELLED = 'CANCELLED',
...
export type TrackerAttribute = {
    ...
    storedBy: string
    value: string
    valueType: TrackerAttribute.valueType
}

export namespace TrackerAttribute {
    export enum valueType {
        TEXT = 'TEXT',
        LONG_TEXT = 'LONG_TEXT',
        MULTI_TEXT = 'MULTI_TEXT',
...
export type TrackerEvent = {
    ...
    dueDate: string
    enrollment: string
    enrollmentStatus: TrackerEvent.enrollmentStatus
    event: string
    eventDate: string
    followup: boolean
    geometry: Record<string, any>
    ...
    program: string
    programStage: string
    programType: TrackerEvent.programType
    relationships: Array<Relationship>
...
export type TrackerImportReport = {
    ...
    message: string
    stats: TrackerStats
    status: TrackerImportReport.status
    timingsStats: TimingsStats
    validationReport: ValidationReport
}

export namespace TrackerImportReport {
    export enum status {
        OK = 'OK',
        WARNING = 'WARNING',
        ERROR = 'ERROR',
