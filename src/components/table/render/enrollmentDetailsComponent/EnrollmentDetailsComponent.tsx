...
import { Label, IconAddCircle16 } from "@dhis2/ui";
...
function EnrollmentDetailsComponent(props: EnrollmentDetailsComponentProps): React.ReactElement {
  const { enrollmentsData, existingAcademicYear, onSelectTei, isOwnershipOu } = props;
    ...
    <React.Fragment>
      <div className="row pb-2 px-1 d-flex justify-content-end align-items-center">
        ...
        <div className="col-12 col-md-4 px-1 pt-2 d-flex justify-content-end">
          {!isOwnershipOu ? <i className={styles.enrolledAlertLabel}>This {sectionName} was transferred to another school.</i> 
